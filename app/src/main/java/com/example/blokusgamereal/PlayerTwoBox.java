...
public class PlayerTwoBox extends SurfaceView {
    ...
    public void onDraw(Canvas c) {
        ...
        c.drawRect(100, 70, 130, 100, blue);

        //Blue 3 piece (1st row 2nd piece)
        c.drawRect(150, 70, 240, 100, blue);
        ...
        //Blue 4 piece (1st row 4th piece)
        c.drawRect(370, 70, 430, 130, blue);
        ...
        c.drawRect(100, 140, 160, 170, blue);
        ...
        //Blue five pieces (3rd row 4th piece)
        piecePath.reset();
        ...
        //Blue five piece (4th row 3rd piece)
        piecePath.reset();
        ...
        //Blue five piece (4th row 4th piece)
        piecePath.reset();
