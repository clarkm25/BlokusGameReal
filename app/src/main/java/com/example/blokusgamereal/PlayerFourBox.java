...
public class PlayerFourBox extends SurfaceView {
    ...
    public void onDraw(Canvas c) {
        ...
        //Yellow 1 piece (1st row 1th piece)
        c.drawRect(100, 70, 130, 100, yellow);

        //Yellow 3 piece (1st row 2th piece)
        c.drawRect(150, 70, 240, 100, yellow);

        //Yellow 5 piece (1st row 3th piece)
        ...
        //Yellow 4 piece (1st row 4th piece)
        ...
        c.drawRect(100, 140, 160, 170, yellow);
        ...
        //Yellow five pieces (3rd row 4th piece)
        piecePath.reset();
        ...
        //Yellow five piece (4th row 3rd piece)
        piecePath.reset();
        ...
        //Yellow five piece (4th row 4th piece)
        piecePath.reset();
